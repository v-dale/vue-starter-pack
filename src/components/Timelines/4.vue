// Credit https://codepen.io/codyhouse/pen/FdkEf/
...
<template>
  <div class="container">
    ...
    <section id="cd-timeline" class="cd-container">
		...
		<div v-for="subject in subjects" :key="subject.id" class="cd-timeline-block">
			<div class="cd-timeline-img cd-picture">
				<img src="@/assets/timeline/cd-icon-picture.svg" alt="Picture" />
			</div>
			<!-- cd-timeline-img -->
			<div class="cd-timeline-content">
				...
				<span class="cd-date">{{ subject.date }}</span>
			</div>
			<!-- cd-timeline-content -->
		</div>
		<!-- cd-timeline-block -->
